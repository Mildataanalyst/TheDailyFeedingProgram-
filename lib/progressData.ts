export const PM_PROFILES = [
  ...
  { name:'Tanishq', tagline:'South India Desk', role:'Program shortlisting', about:'Supports NGO shortlisting and review across the South India workstream.', img:'/pm/tanishq.jpg' },
] as const;
